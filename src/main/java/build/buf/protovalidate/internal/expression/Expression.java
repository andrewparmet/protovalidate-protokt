...
import protokt.v1.buf.validate.priv.Constraint;
...
public class Expression {
   ...
   */
  private Expression(protokt.v1.buf.validate.Constraint constraint) {
   ...
   */
  private Expression(protokt.v1.buf.validate.priv.Constraint constraint) {
    this(constraint.getId(), constraint.getMessage(), constraint.getExpression());
  }
  ...
  public static List<Expression> fromPrivConstraints(
      List<protokt.v1.buf.validate.priv.Constraint> constraints) {
   ...
   * @return The list of expressions.
   */
  public static List<Expression> fromConstraints(List<protokt.v1.buf.validate.Constraint> constraints) {
    List<Expression> expressions = new ArrayList<>();
    for (protokt.v1.buf.validate.Constraint constraint : constraints) {
      expressions.add(new Expression(constraint));
    }
    return expressions;
  }
